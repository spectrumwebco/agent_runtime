...
This module provides Pydantic models for GitHub API responses and data structures
used in the GitHub issue scraper.
"""
...
class GitHubRepository(BaseModel):
    ...
    owner: Optional[GitHubUser] = Field(None, description="Repository owner")
...
class GitHubIssue(BaseModel):
    ...
    repository: Optional[GitHubRepository] = Field(None, description="Repository this issue belongs to")
...
class GitHubSearchResult(BaseModel):
    ...
    items: List[GitHubIssue] = Field(..., description="Search results")


class GitHubScraperConfig(BaseModel):
    """GitHub scraper configuration model."""
