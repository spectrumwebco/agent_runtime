...
class ModelRegistryConfig:
    ...
    model_description: str = "Fine-tuned Llama 4 model for GitOps, Terraform, and Kubernetes issues"
    ...
    production_criteria: Dict[str, float] = field(default_factory=lambda: {
        "accuracy": 0.8,
        "f1": 0.8,
...
class ModelRegistry:
        ...
        try:
            ...
            if metrics and self.config.auto_alias:
                ...
                if stage:
                    ...
                    logger.info(f"Transitioned model {model_name} version {model_version} to {stage}")
    ...
    def create_model_deployment(
        ...
        try:
            ...
            logger.info(f"Creating deployment for {model_uri} with config: {deployment_config}")
