...
class FineTuningJobCreate(BaseModel):
    ...
    hyperparameters: Optional[HyperParameters] = Field(None, description="Hyperparameters for fine-tuning")
...
class InferenceServiceList(BaseModel):
    ...
    services: List[InferenceServiceBase] = Field(..., description="List of inference services")
...
class KServeModelCreate(BaseModel):
    ...
    resources: Optional[ResourceRequirements] = Field(None, description="Resource requirements")
    env: Optional[List[Dict[str, Any]]] = Field(None, description="Environment variables")
