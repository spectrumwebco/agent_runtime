...
class GiteeClient:
    ...
    def _make_request(self, method: str, endpoint: str, params: Optional[Dict[str, Any]] = None, 
        ...
        try:
            ...
            raise GiteeAPIError(error_message, status_code=status_code, response=response_data) from e
    ...
    def create_branch(self, owner: str, repo: str, branch: str, ref: str) -> Dict[str, Any]:
        """Create a new branch in a repository."""
        data = {
            "refs": f"refs/heads/{branch}",
            "sha": ref
        }
        return self._make_request("POST", f"/repos/{owner}/{repo}/branches", json_data=data)
    ...
    def create_pull_request(self, owner: str, repo: str, title: str, head: str, base: str, 
        ...
        return self._make_request("POST", f"/repos/{owner}/{repo}/pulls", json_data=data)
    ...
    def create_issue(self, owner: str, repo: str, title: str, body: str = "") -> Dict[str, Any]:
        ...
        return self._make_request("POST", f"/repos/{owner}/{repo}/issues", json_data=data)
    
    def create_issue_comment(self, owner: str, repo: str, issue_number: int, body: str) -> Dict[str, Any]:
        """Create a comment on an issue."""
        data = {"body": body}
        return self._make_request("POST", f"/repos/{owner}/{repo}/issues/{issue_number}/comments", json_data=data)
