...
class GitHubProvider(RepoProvider):
    ...
    def create_pull_request(self, owner: str, repo: str, title: str, head: str, base: str, 
                           body: str = "", draft: bool = False) -> Dict[str, Any]:
        return self.client.create_pull_request(owner, repo, title, head, base, body, draft)
...
def get_repo_provider(provider_type: RepoProviderType, token: Optional[str] = None) -> RepoProvider:
