...
from apps.python_agent.agent_framework.runtime.abstract import Action, Command, CreateSessionRequest
...
def run_agent_view(request):
    ...
    try:
        ...
        session_response = loop.run_until_complete(runtime.create_session(session_request))
