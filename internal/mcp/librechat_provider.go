...
type LibreChatMCPProvider struct {
	client *librechat.Client
}

func NewLibreChatMCPProvider(baseURL string) *LibreChatMCPProvider {
	apiKey := os.Getenv("LIBRECHAT_CODE_API_KEY")
	return &LibreChatMCPProvider{
		client: librechat.NewClient(baseURL, apiKey),
	}
}

func (p *LibreChatMCPProvider) RegisterHandlers(mux *http.ServeMux) {
...
func (p *LibreChatMCPProvider) handleExecute(w http.ResponseWriter, r *http.Request) {
...
func (p *LibreChatMCPProvider) handleExecuteMulti(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
		return
	}
...
func (p *LibreChatMCPProvider) handleGetLanguages(w http.ResponseWriter, r *http.Request) {
...
func (p *LibreChatMCPProvider) handleGetDocs(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
		return
	}
