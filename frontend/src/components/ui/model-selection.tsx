...
const availableModels = [
  { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', provider: 'Google', type: 'Large' },
  { id: 'claude-3-5-sonnet', name: 'Claude 3.5 Sonnet', provider: 'Anthropic', type: 'Large' },
  { id: 'llama-3-70b', name: 'Llama 3 70B', provider: 'Meta', type: 'Large' },
  { id: 'gpt-4o', name: 'GPT-4o', provider: 'OpenAI', type: 'Large' },
  { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', provider: 'Google', type: 'Fast' },
  { id: 'claude-3-haiku', name: 'Claude 3 Haiku', provider: 'Anthropic', type: 'Fast' },
];
