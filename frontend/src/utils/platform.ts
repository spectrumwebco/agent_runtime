...
export const platformFeatures = {
  common: {
    supportsLocalStorage: typeof window !== 'undefined' && !!window.localStorage,
  ...
  mobile: {
    supportsTouch: typeof navigator !== 'undefined' && 
      ('maxTouchPoints' in navigator && navigator.maxTouchPoints > 0),
    supportsGeolocation: typeof navigator !== 'undefined' && !!navigator.geolocation,
    supportsCamera: typeof navigator !== 'undefined' && 
