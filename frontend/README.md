# Getting Started with the Kled.io Frontend

## Overview

This is the frontend of the Kled.io project. It is a React application that provides a web interface for the Kled.io project.
...
1. **Component Testing**
   ...
   - Use our custom [`renderWithProviders()`](https://github.com/spectrumwebco/agent_runtime/blob/main/frontend/test-utils.tsx) that wraps the components we want to test in our providers. It is especially useful for components that use Redux
...
1. **Chat Input Component Test**:
   [`__tests__/components/chat/chat-input.test.tsx`](https://github.com/spectrumwebco/agent_runtime/blob/main/frontend/__tests__/components/chat/chat-input.test.tsx)
...
2. **File Explorer Component Test**:
   [`__tests__/components/file-explorer/file-explorer.test.tsx`](https://github.com/spectrumwebco/agent_runtime/blob/main/frontend/__tests__/components/file-explorer/file-explorer.test.tsx)
